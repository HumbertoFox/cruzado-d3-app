            ...
            <div className={`${isRunesBombardment ? 'flex' : 'hidden'} flex-col gap-3 py-3`}>
                <div className='flex items-center gap-5'>
                    ...
                    <div className='flex flex-col gap-1 font-mono text-sm'>
                        ...
                        <span className='italic'>Requer Nível <strong>63</strong></span>
                        <p>
                ...
                <div className='flex items-center gap-5'>
                    ...
                    <div className='flex flex-col gap-1 font-mono text-sm'>
                        ...
                        <span className='italic'>Requer Nível <strong>65</strong></span>
                        <p>
                ...
                <div className='flex items-center gap-5'>
                    ...
                    <div className='flex flex-col gap-1 font-mono text-sm'>
                        ...
                        <span className='italic'>Requer Nível <strong>67</strong></span>
                        <p>
                ...
                <div className='flex items-center gap-5'>
                    ...
                    <div className='flex flex-col gap-1 font-mono text-sm'>
                        ...
                        <span className='italic'>Requer Nível <strong>69</strong></span>
                        <p>
                ...
                <div className='flex items-center gap-5'>
                    ...
                    <div className='flex flex-col gap-1 font-mono text-sm'>
                        ...
                        <span className='italic'>Requer Nível <strong>70</strong></span>
                        <p>
